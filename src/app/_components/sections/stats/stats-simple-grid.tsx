          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Drive Your Destiny with Premium Car Rentals
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Experience unparalleled convenience and luxury with our top-of-the-line rental fleet. Book your ride today and journey with confidence.
              </p>
            </div>
